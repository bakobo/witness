...
- **Error response quality (format-agnostic).** JSON or HTML is fine. Full standard: `bakobo/dev/standards/error-handling.md`. In brief, regardless of format, every error response must:
