...
```json
{"registrar": "B…", "number": 7, "full": false, "window_end": "2026-11-17T10:00:05+00:00",
...
- An Observer that sees a gap unsubscribes and subscribes again, which starts a new sequence with a full batch.
